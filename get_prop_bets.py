...
def get_props(player_name, stat, date):
    ...
    name_space_index = player_name.index(" ")
    new_name = (player_name[:name_space_index] + player_name[name_space_index + 1:]).lower()
    new_date = ""
    ...
    for player in props[new_date]:
        ...
        if new_name == player[-0][:-4]:
            return (player[1], player[2])

    return None

# print(get_props("Stephen Curry", "pts", "Sun, Feb 27, 2022"))
# print(get_props("Stephen Curry", "ast", "Tue, Apr 4, 2023"))