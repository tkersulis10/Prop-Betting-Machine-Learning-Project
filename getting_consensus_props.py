...
driver = webdriver.Chrome(executable_path=driver_paths[1], options=chrome_options)

def get_props_for_date(stat_type, year, month, day):
    print(str(month) + " " + str(day) + " " + str(year))
    with open(stat_type + "_prop_lines_raw.txt", "a") as file:
        main_url = "https://www.bettingpros.com/nba/odds/player-props/" + stat_type + "/?date="
